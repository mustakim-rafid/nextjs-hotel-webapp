...
const HeroSectionFacilities = () => {
  return (
    <div className={`bg-[url("/images/facilitiesimg.png")] bg-gray-400 bg-cover bg-center xl:bg-bottom xl:h-screen lg:h-[80vh] md:h-[70vh] relative`} style={{ backgroundBlendMode: "multiply" }}>
        <Navbar />
